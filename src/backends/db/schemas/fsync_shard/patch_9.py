...
"""Drop the directory hash column, as dirs have no content anymore."""
...
SQL = [
    ...
    CREATE VIEW share_delta_view AS
        ...
        o.volume_id, o.parent_id, o.name, o.content_hash, o.kind,
        o.mimetype, o.when_created, o.when_last_modified, o.status, o.path,
        o.publicfile_id, o.public_uuid, o.generation, o.generation_created
        FROM object o
    UNION
        ...
        movefromshare.content_hash, movefromshare.kind,
        movefromshare.mimetype, movefromshare.when_created,
    ...
    """,
    """
    ALTER TABLE object DROP COLUMN directory_hash;
    """,
    """
    ALTER TABLE movefromshare DROP COLUMN directory_hash;
    """,
]
